...
Link_tip: 'Link: áramkör megosztása',
...
Perform_Transient_Analysis: 'Átmeneti jelenségek elemzés végrehajtása',
Transient_Analysis: 'Átmeneti jelenségek elemzés',
...
ckt_alert3: 'Kérjük csatlakoztasson legalább egy földelést (háromszög jel).',
...
Stop_time_seconds: 'Befejező idő (másodperc)',
tstop_lbl: 'Befejező idő',
Transient_Analysis_add_a_probe: 'Átmeneti jelenségek elemzés: adjon az ábrához egy szondát!',
...
impulse: 'impulzus',
Height: 'Magasság',
Width: 'Szélesség (másodperc)',

step: 'lépcső',
Initial_value: 'Kezdő érték',
Plateau_value: 'Tetőző érték',
Delay_until_step: 'Késleltetés (másodperc)',
Rise_time: 'Növekedési idő (másodperc)',
...
pulse: 'lüktetés',
Delay_until_pulse: 'Késleltetés lüktetésig (másodperc)',
Time_for_first_transition: 'Első átmenet ideje (másodperc)',
Time_for_second_transition: 'Második átmenet ideje (másodperc)',
Pulse_width: 'Lüktetés szélesség (másodperc)',
Period: 'Periódus (másodperc)',

sin: 'szinusz',
Offset_value: 'Eltolás mértéke',
Amplitude: 'Amplitúdó',
Delay_until_sin_starts: 'Késleltetés ideje (másodperc)',
