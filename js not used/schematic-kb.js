...
var cktsim = (function() {
	...
	Circuit.prototype.load_netlist = function(netlist, show_dialog) {
...
schematic = (function() {
	...
	*/
	...
	Schematic.prototype.extract_circuit = function() {
	    ...
	    var sch = this;		//gives access to methods inside parent QQQ
	    var show_dialog = function(title, content) {
	    	console.log('title = ' + title);
	    	sch.dialog(title,content,function() {
	    		console.log("dialog dismissed");
	    	});
	    }

	    if (ckt.load_netlist(netlist, show_dialog))
	    	return ckt;
	    else
	    	return null;
	}
	...
	Schematic.prototype.window = build_window;			//go back!@ QQQ
