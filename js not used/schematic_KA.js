...
// WMc The window.onload line was removed by EdX (SJSU), with the following warning
/*
...
schematic = (function() {
	...
	Schematic.prototype.help = function() {
		...
		var strMove = "Move: Select, then drag to a new location.\n\n";
		var strDel  = "Delete: Select, then click the X icon or hit BACKSPACE.\n\n";
		var strRot  = "Rotate/Reflect: Select, then click on the rotation arrow or type the letter \"r\" to rotate 90. Repeat for more rotations and reflections.\n\n";
