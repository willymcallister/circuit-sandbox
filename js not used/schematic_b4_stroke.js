...
Schematic.prototype.transient_analysis = function() {
	...
	Schematic.prototype.redraw = function() {
		...
		var s = 6;			// stroke length
		var t = 6;			// portion of height
		...
		// zoom out minus
		c.moveTo(x-s,y+3*t+o); c.lineTo(x+s,y+3*t+o);
		// zoom all box
...
*/
	...
	Schematic.prototype.draw_line = function(c,x1,y1,x2,y2,width) {
		...
		c.beginPath();
		c.moveTo((x1 - this.origin_x) * this.scale,(y1 - this.origin_y) * this.scale);	//QQQ offset by 0.5?
